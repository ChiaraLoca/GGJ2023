...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        private void GatherInput() {
            ...
            if (Input.X != 0 && (m_FacingRight != (Input.X >= 0)))
            {
                Flip();
            }
        ...
        private void CalculateWalk() {
            ...
            animator.SetBool("walking", Mathf.Abs(_currentHorizontalSpeed) > 1 && Grounded && !knocked);
        ...
        private void CalculateJump() {
            ...
            animator.SetBool("airtime", !Grounded);
        ...
        {
            if (col.gameObject.layer == (int)Mathf.Log(_enemyLayer, 2))
            {
        ...
        private void Knockback(Collision2D collision)
        {
            ...
            if (canBeKnocked)
            {
                ...
                distance.y = 25f;
                _currentHorizontalSpeed = distance.x * 5;
                _currentVerticalSpeed = distance.y;
